...
export default function* watch() {
  yield all([
    ...
    takeLatest(types.GET_EXPENSE_REQUEST, userSaga.getExpenseAsync),
    takeLatest(types.ADD_COMMENT_REQUEST, userSaga.addCommentAsync),
    takeLatest(types.GET_COMMENT_REQUEST, userSaga.getCommentAsync),
