...
export const GROUP_UPLOAD_IMAGE_RESPONSE = "GROUP_UPLOAD_IMAGE_RESPONSE";
export const GROUP_UPLOAD_IMAGE_REQUEST = "GROUP_UPLOAD_IMAGE_REQUEST";
...
export const PUSH_NOTIFICATION_RESPONSE = "PUSH_NOTIFICATION_RESPONSE";
export const REMIND_MEMBER_REQUEST = "REMIND_MEMBER_REQUEST";
export const REMIND_MEMBER_RESPONSE = "REMIND_MEMBER_RESPONSE";
